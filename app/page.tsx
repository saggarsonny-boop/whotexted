...
export default function Home() {
  ...
  return (
    <main className={styles.main}>
      <AutoDemo />
      <FirstVisitCard />
      <TooltipTour engineId="whotextedme" tips={[
        { label: "Phone number input", text: "Enter any phone number with country code — +44, +1, +61, etc. Press Enter or tap Look up." },
        { label: "Carrier and line type", text: "Shows the network carrier and whether it is a mobile, landline, or VoIP number." },
        { label: "Location", text: "Geographic region associated with the number prefix — city or country depending on carrier data." },
        { label: "Search further", text: "Links to Google, TruePeopleSearch, and Whitepages for deeper reverse lookup if needed." },
      ]} />
